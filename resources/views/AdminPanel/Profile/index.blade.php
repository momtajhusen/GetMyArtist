                  ...
                  <div class="col-12">
                    <div class="card mb-6">
                      <div class="user-profile-header-banner">
                        <img src="../../assets/img/pages/profile-banner.png" style="width: 100%" alt="Banner image" class="rounded-top" />
                      </div>
                      <div class="user-profile-header d-flex flex-column flex-lg-row text-sm-start text-center mb-5">
                        <div class="flex-shrink-0 mt-n2 mx-sm-0 mx-auto">
                          <img
                            {{-- src="../../assets/img/avatars/1.png" --}}
                            src="{{ asset('storage/' . $artist->profile_photo) }}"
                            alt="user image"
                        ...
                        <div class="flex-grow-1 mt-3 mt-lg-5">
                          <div
                            ...
                            <div class="user-profile-info">
                              <h4 class="mb-2 mt-lg-6">{{ $artist->stage_name }}</h4>
                              <ul
                                class="list-inline mb-0 d-flex align-items-center flex-wrap justify-content-sm-start justify-content-center gap-4 my-2">
                                <li class="list-inline-item">
                                  <i class="icon-base ti tabler-palette icon-lg me-2"></i> {{ $artist->category_id }}
                                </li>
                                <li class="list-inline-item">
                                  <i class="icon-base ti tabler-map-pin icon-lg me-2"></i> {{ $artist->location }}
                                </li>
                                <li class="list-inline-item">
                                  <i class="icon-base ti tabler-calendar icon-lg"></i>
                                  <span class="fw-medium">Joined {{ $artist->created_at->format('F Y') }}</span>
                                </li>                              
                              </ul>
                            </div>
                    ...
                    <div class="card h-100">
                      ...
                      <div class="card-body border-top">
                        ...
                        <div class="d-flex align-items-center">
                          ...
                          <div class="ms-auto">
                            <a href="javascript:void(0);" class="text-body-secondary d-flex align-items-center"
                              ><i class="icon-base ti tabler-message-dots icon-lg me-1"></i> 15</a
                            >
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="card h-100">
                      ...
                      <div class="card-body border-top">
                        ...
                        <div class="d-flex align-items-center">
                          ...
                          <div class="ms-auto">
                            <a href="javascript:void(0);" class="text-body-secondary d-flex align-items-center"
                              ><i class="icon-base ti tabler-message-dots icon-lg me-2"></i> 236</a
                            >
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="card">
                      ...
                      <div class="card-body border-top">
                        ...
                        <div class="d-flex align-items-center">
                          ...
                          <div class="ms-auto">
                            <a href="javascript:void(0);" class="text-body-secondary d-flex align-items-center"
                              ><i class="icon-base ti tabler-message-dots icon-lg me-1"></i> 98</a
                            >
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="card">
                      ...
                      <div class="card-body border-top">
                        ...
                        <div class="d-flex align-items-center">
                          ...
                          <div class="ms-auto">
                            <a href="javascript:void(0);" class="text-body-secondary d-flex align-items-center"
                              ><i class="icon-base ti tabler-message-dots icon-lg me-1"></i> 120</a
                            >
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="card">
                      ...
                      <div class="card-body border-top">
                        ...
                        <div class="d-flex align-items-center">
                          ...
                          <div class="ms-auto">
                            <a href="javascript:void(0);" class="text-body-secondary d-flex align-items-center"
                              ><i class="icon-base ti tabler-message-dots icon-lg me-1"></i> 20</a
                            >
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="card">
                      ...
                      <div class="card-body border-top">
                        ...
                        <div class="d-flex align-items-center">
                          ...
                          <div class="ms-auto">
                            <a href="javascript:void(0);" class="text-body-secondary d-flex align-items-center"
                              ><i class="icon-base ti tabler-message-dots icon-lg me-1"></i> 37</a
                            >
                          </div>
                        </div>
                      </div>
